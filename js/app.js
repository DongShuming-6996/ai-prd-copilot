(function (global) {
  ...
  var App = {
    ...
    renderQuestionsHTML: function (p) {
      ...
      html += '<button class="btn primary pulse" id="q-confirm-all" style="width:100%;padding:10px 16px;font-size:13px;font-weight:600" onclick="App.confirmAllAnswers()">一键全部使用建议答案</button>';
      html += "</div>";
    ...
    renderStep2AIBar: function (p) {
      ...
      this.setFixedBar(
        ...
        '<button class="btn primary" id="fb-go-edit" style="flex:1;padding:10px 14px;font-size:13px" onclick="App.goToEditorFromQuestions()">进入富文本编辑</button>'
      );
      // 事件在 wireStep2AI 中绑定
    },
