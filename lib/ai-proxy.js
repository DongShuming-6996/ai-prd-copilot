// AI 代理公共逻辑：本地 server.js 与 Vercel api/ai.js 共用
// Key 只在服务端读取（环境变量 OPENAI_API_KEY），永不进入前端
...
async function handleAction(body) {
  ...
  try {
    ...
    if (body.action === "draft" && Array.isArray(body.materials) && Array.isArray(body.sections)) {
      ...
      return { status: 200, payload: { usedDemo: false, ...normalizeDraft(raw, body.sections) } };
    }
...
module.exports = { handleAction, hasServerKey };
